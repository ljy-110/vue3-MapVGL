!function(t, e) {
        ...
        if (n.bigData) {
          ...
          r = i.length; a < r; a++) {
            ...
            'Point' == h || 'Polygon' == h || 'MultiPolygon' == h
              ? (t.fill(),
              (s.strokeStyle || n.strokeStyle) && n.lineWidth && t.stroke())
              : 'LineString' != h && 'MultiLineString' != h || ((s.lineWidth || s._lineWidth) && (t.lineWidth = s.lineWidth || s._lineWidth),
              t.stroke()),
            t.restore();
          }
        t.restore();
  ...
  'undefined' == typeof window && 'undefined' != typeof process
    ...
    : 'undefined' != typeof window && void 0 !== window.performance && void 0 !== window.performance.now
      ? xt.now = window.performance.now.bind(window.performance)
      : void 0 !== Date.now
        ? xt.now = Date.now
        : xt.now = function() {
    ...
    this.update = function(t) {
      ...
      p)
        if (void 0 !== c[e]) {
          ...
          a instanceof Array
            ? u[e] = w(a, i)
            : ('string' == typeof a && (a = '+' === a.charAt(0) || '-' === a.charAt(0) ? o + parseFloat(a) : parseFloat(a)),
  ...
  xt.Interpolation = {
    ...
    CatmullRom: function(t, e) {
      ...
      return t[0] === t[n]
        ...
        : e < 0 ? t[0] - (a(t[0], t[0], t[1], t[1], -i) - t[0]) : 1 < e ? t[n] - (a(t[n], t[n], t[n - 1], t[n - 1], i - n) - t[n]) : a(t[o ? o - 1 : 0], t[o], t[n < o + 1 ? n : o + 1], t[n < o + 2 ? n : o + 2], i - o);
    },
    Utils: {
    ...
    Lt = {
      ...
      drawIcon: function(t, e, n) {
        ...
        if (h.url) {
          ...
          w
            ? 'error' === w ? i() : l && u ? n.drawImage(w, r, s, l, u) : n.drawImage(w, r, s)
            : (Et[_] || (Et[_] = [],
            f = _,
            m = function(e, t) {
  ...
  var Gt = (e(Jt, [{
    ...
    value: function(t) {
      ...
      return 'Feature' !== t.type
        ? []
        : this.supercluster.getChildren(t.id).map(function(t) {
      ...
      value: function() {
        ...
        if (t) {
          ...
          o.getMapType().getProjection
            ? n = (e = o.getMapType().getProjection()).lngLatToPoint(o.getCenter())
            : (-180 < (n = {
              x: o.getCenter().lng,
              y: o.getCenter().lat
            }).x && n.x < 180 && (n = {
      ...
      value: function(n) {
        if (this.canvasLayer) {
          ...
          r.getMapType().getProjection
            ? e = (t = r.getMapType().getProjection()).lngLatToPoint(r.getCenter())
            : (-180 < (e = {
              x: r.getCenter().lng,
              y: r.getCenter().lat
            }).x && e.x < 180 && (e = {
          ...
          if (!(this.options.minZoom && r.getZoom() < this.options.minZoom || this.options.maxZoom && r.getZoom() > this.options.maxZoom)) {
            ...
            if ('cluster' === this.options.draw && (!this.options.maxClusterZoom || this.options.maxClusterZoom >= v)) {
              ...
              var y = {},
                x = null,
                _ = null;
              this.pointCountMax === this.pointCountMin
                ? (x = this.options.fillStyle,
                _ = this.options.minSize || 8)
                : y = new D({
              ...
              for (var w = 0; w < m.length; w++) {
                var b = m[w];
                b.properties && b.properties.cluster_id
                  ? (m[w].size = _ || y.getSize(b.properties.point_count),
                  m[w].fillStyle = x || y.getColor(b.properties.point_count))
                  : m[w].size = o.options.size;
              }
            ...
            'm' == o.options.unit
              ...
              o.options.height && (o.options._height = o.options.height / i))
    ...
    e(ve, [{
      ...
      value: function(t, n) {
        if (this.canvas) {
          ...
          e.processData(h),
          'm' == e.options.unit
            ? (e.options.size && (e.options._size = e.options.size / zoomUnit),
            e.options.width && (e.options._width = e.options.width / zoomUnit),
            e.options.height && (e.options._height = e.options.height / zoomUnit))
      ...
      value: function() {
        if (!this.canvas) {
          ...
          '2d' === this.layer.baseLayer.context
            ...
            'heatmap' !== this.layer.baseLayer.options.draw && 1 !== n && this.context.scale(n, n))
    ...
    e(me, [{
      ...
      value: function(t, n) {
        if (t) {
          ...
          'm' === this.options.unit
            ? (this.options.size && (this.options._size = this.options.size / zoomUnit),
            this.options.width && (this.options._width = this.options.width / zoomUnit),
            this.options.height && (this.options._height = this.options.height / zoomUnit))
  ...
  e(xe, [{
    ...
    value: function(t, e) {
      if (this.$Map) {
        ...
        e
          ? n.style.cursor !== t && (this.previousCursor_ = n.style.cursor,
          n.style.cursor = t)
          : void 0 !== this.previousCursor_ && (n.style.cursor = this.previousCursor_,
